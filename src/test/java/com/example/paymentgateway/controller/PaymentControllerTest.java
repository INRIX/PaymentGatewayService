...
public class PaymentControllerTest {
    ...
    void testPingReturnDefaultMessage() throws Exception {
        this.mockMvc.perform(get("/payments/ping")).andDo(print()).andExpect(status().isOk())
    ...
    void testPay1shouldReturnPaymentWasSuccessful()  throws Exception {
        this.mockMvc.perform(post("/payments/pay1").contentType(MediaType.APPLICATION_JSON)
